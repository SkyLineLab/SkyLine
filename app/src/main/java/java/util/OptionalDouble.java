...
public final class OptionalDouble {
    ...
    public boolean equals(Object obj) {
        ...
        return (isPresent && ((OptionalDouble) other).isPresent)
               ? Double.compare(value, ((OptionalDouble) other).value) == 0
               : isPresent == ((OptionalDouble) other).isPresent;
    }
