            ...
            public Spliterator<E> trySplit() {
                if (splSpineIndex < lastSpineIndex) {
                    ...
                    if (t == 0)
                        ...
                        Spliterator<E> ret = java.util.J8Arrays.spliterator(splChunk, splElementIndex, splElementIndex + t);
                        splElementIndex += t;
                        return ret;
                    }
                }
        ...
        public Spliterator.OfInt spliterator() {
            class Splitr extends BaseSpliterator<Spliterator.OfInt>
                ...
                OfInt arraySpliterator(int[] array, int offset, int len) {
                    return java.util.J8Arrays.spliterator(array, offset, offset+len);
                }
            }
            return new Splitr(0, spineIndex, 0, elementIndex);
        }
