...
import java.lang.Integers;
import java.lang.Longs;
...
/**
 * A place for the new {@link Arrays} methods added in Java 8 and Java
...
public final class J8Arrays {
     ...
     * considered equal.
     *
     * <p>The comparison is consistent with {@link Arrays#equals(Object[], Object[]) equals},
     ...
     * references are considered equal.
     *
     * <p>The comparison is consistent with {@link Arrays#equals(int[], int[]) Arrays.equals},
     * more specifically the following holds for arrays {@code a} and {@code b}:
     * <pre>{@code
     *     java.util.Arrays.equals(a, b) == (J8Arrays.compare(a, b) == 0)
     * }</pre>
     ...
     *     int i = J8Arrays.mismatch(a, b);
     *     if (i >= 0 && i < Math.min(a.length, b.length))
     *         return java.lang.Integers.compare(a[i], b[i]);
     *     return a.length - b.length;
     * }</pre>
     *
     * @param a the first array to compare
     ...
     *                               b, bFromIndex, bToIndex);
     *     if (i >= 0 && i < Math.min(aToIndex - aFromIndex, bToIndex - bFromIndex))
     *         return java.lang.Integers.compare(a[aFromIndex + i], b[bFromIndex + i]);
     *     return (aToIndex - aFromIndex) - (bToIndex - bFromIndex);
     * }</pre>
     *
     * @param a the first array to compare
     ...
     * references are considered equal.
     *
     * <p>The comparison is consistent with {@link Arrays#equals(long[], long[]) Arrays.equals},
     * more specifically the following holds for arrays {@code a} and {@code b}:
     * <pre>{@code
     *     java.util.Arrays.equals(a, b) == (J8Arrays.compare(a, b) == 0)
     * }</pre>
     ...
     *     int i = J8Arrays.mismatch(a, b);
     *     if (i >= 0 && i < Math.min(a.length, b.length))
     *         return java.lang.Longs.compare(a[i], b[i]);
     *     return a.length - b.length;
     * }</pre>
     *
     * @param a the first array to compare
     ...
     *                               b, bFromIndex, bToIndex);
     *     if (i >= 0 && i < Math.min(aToIndex - aFromIndex, bToIndex - bFromIndex))
     *         return java.lang.Longs.compare(a[aFromIndex + i], b[bFromIndex + i]);
     *     return (aToIndex - aFromIndex) - (bToIndex - bFromIndex);
     * }</pre>
     *
     * @param a the first array to compare
     ...
     * references are considered equal.
     *
     * <p>The comparison is consistent with {@link Arrays#equals(double[], double[]) Arrays.equals},
     * more specifically the following holds for arrays {@code a} and {@code b}:
     * <pre>{@code
     *     java.util.Arrays.equals(a, b) == (J8Arrays.compare(a, b) == 0)
     * }</pre>
