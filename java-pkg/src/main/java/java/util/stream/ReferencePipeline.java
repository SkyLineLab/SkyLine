...
abstract class ReferencePipeline<P_IN, P_OUT>
    ...
    public List<P_OUT> toList() {
        try {
            return (List<P_OUT>) Class.forName("java.util.ImmutableCollections").getDeclaredMethod("listFromTrustedArrayNullsAllowed", Object[].class).invoke(null, (Object) this.toArray());
