...
public final class Spliterators {
     ...
     * interfaces {@link List}, {@link Set} or
     * {@link SortedSet} the returned {@code Spliterator} will
     ...
     *
     * <p>
     * Particularly, if the given collection is a {@link List}, the
     * implementation creates a
     * <em><a href="Spliterator.html#binding">late-binding</a></em>
     * spliterator as follows:
     * <ul>
     * <li>If the list is an instance of {@link RandomAccess} then
     *     the default implementation creates a spliterator that traverses
     *     elements by invoking the method {@link List#get}.  If
     ...
     *     If the list is also an instance of {@link AbstractList}
     *     then the spliterator will use the list's
     *     {@link AbstractList#modCount modCount} field to provide
