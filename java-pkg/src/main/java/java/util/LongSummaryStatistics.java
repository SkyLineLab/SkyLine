...
public class LongSummaryStatistics implements LongConsumer, IntConsumer {
    ...
    public void combine(LongSummaryStatistics other) {
        count += ((LongSummaryStatistics) other).count;
        sum += ((LongSummaryStatistics) other).sum;
        min = Math.min(min, ((LongSummaryStatistics) other).min);
        max = Math.max(max, ((LongSummaryStatistics) other).max);
    }
