...
// CVS rev. 1.41
    ...
    private static final class RandomIntsSpliterator implements Spliterator.OfInt {
        ...
        public RandomIntsSpliterator trySplit() {
            ...
            return (m <= i) ? null :
                new RandomIntsSpliterator(((SplittableRandom) rng).split(), i, index = m, origin, bound);
        }
        ...
        public boolean tryAdvance(IntConsumer consumer) {
            ...
            if (i < f) {
                consumer.accept(((SplittableRandom) rng).internalNextInt(origin, bound));
                index = i + 1;
                return true;
            }
            return false;
        ...
        public void forEachRemaining(IntConsumer consumer) {
            ...
            if (i < f) {
                ...
                do {
                    consumer.accept(((SplittableRandom) r).internalNextInt(o, b));
                } while (++i < f);
            }
        }
    }
    ...
    private static final class RandomLongsSpliterator implements Spliterator.OfLong {
        ...
        public boolean tryAdvance(LongConsumer consumer) {
            ...
            long i = index, f = fence;
            if (i < f) {
                consumer.accept(((SplittableRandom) rng).internalNextLong(origin, bound));
                index = i + 1;
                return true;
            }
            return false;
        ...
        public void forEachRemaining(LongConsumer consumer) {
            ...
            if (i < f) {
                ...
                do {
                    consumer.accept(((SplittableRandom) rng).internalNextLong(o, b));
                } while (++i < f);
            }
        }
    }
    ...
    private static final class RandomDoublesSpliterator implements Spliterator.OfDouble {
        ...
        public boolean tryAdvance(DoubleConsumer consumer) {
            ...
            long i = index, f = fence;
            if (i < f) {
                consumer.accept(((SplittableRandom) rng).internalNextDouble(origin, bound));
                index = i + 1;
                return true;
            }
            return false;
        ...
        public void forEachRemaining(DoubleConsumer consumer) {
            ...
            if (i < f) {
                ...
                do {
                    consumer.accept(((SplittableRandom) rng).internalNextDouble(o, b));
                } while (++i < f);
            }
        }
    }
