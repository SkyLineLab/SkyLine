...
public class IntSummaryStatistics implements IntConsumer {
    ...
    public void combine(IntSummaryStatistics other) {
        count += ((IntSummaryStatistics) other).count;
        sum += ((IntSummaryStatistics) other).sum;
        min = Math.min(min, ((IntSummaryStatistics) other).min);
        max = Math.max(max, ((IntSummaryStatistics) other).max);
    }
