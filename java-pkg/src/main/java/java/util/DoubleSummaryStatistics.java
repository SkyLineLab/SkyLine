 ...
 * {@linkplain java.util.stream.Stream streams}. For example, you can compute
...
public class DoubleSummaryStatistics implements DoubleConsumer {
    ...
    public void combine(DoubleSummaryStatistics other) {
        count += ((DoubleSummaryStatistics) other).count;
        simpleSum += ((DoubleSummaryStatistics) other).simpleSum;
        sumWithCompensation(((DoubleSummaryStatistics) other).sum);
        sumWithCompensation(-((DoubleSummaryStatistics) other).sumCompensation);
        min = Math.min(min, ((DoubleSummaryStatistics) other).min);
        max = Math.max(max, ((DoubleSummaryStatistics) other).max);
    }
