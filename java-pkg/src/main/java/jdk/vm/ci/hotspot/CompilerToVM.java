...
//    private static native void registerNatives();
    ...
    int installCode(HotSpotCompiledCode compiledCode, InstalledCode code, long failedSpeculationsAddress, byte[] speculations) {
        ...
        if ((codeInstallFlags & 0x0004) != 0 && Option.CodeSerializationTypeInfo.isDefault) {
            withTypeInfo = true;
        } else {
            withTypeInfo = Option.CodeSerializationTypeInfo.getBoolean();
        }
    ...
    /**
     * Gets a {@link JavaConstant} wrapping the {@link Class} mirror for {@code klass}.
     */
